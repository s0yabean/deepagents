...
- **FORMAT**: `write_todos` expects a List of Dictionaries. Example: `[{"content": "Task...", "status": "in_progress", "owner": "plain-speaker"}]`
- **ALLOWED STATUSES**: `"pending"`, `"in_progress"`, `"completed"`.
- **CRITICAL**: Always include the `"owner": "plain-speaker"` field.
